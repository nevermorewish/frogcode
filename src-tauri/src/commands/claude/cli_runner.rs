...
fn create_command_with_env(program: &str) -> Command {
    ...
    // 🔥 REMOVED: DISABLE_* environment variables
    // These flags were added to work around Claude CLI issues, but may interfere
    // with normal Claude CLI functionality. Let Claude CLI manage its own features.
