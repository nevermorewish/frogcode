...
[![Release](https://img.shields.io/github/v/release/anyme123/frog-code?style=flat-square)](https://github.com/anyme123/frog-code/releases)
[![License](https://img.shields.io/badge/license-AGPL--3.0-blue.svg?style=flat-square)](LICENSE)
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-lightgrey.svg?style=flat-square)](https://github.com/anyme123/frog-code)
...
Frog Code 是一个为 AI 驱动的代码开发工作流量身打造的专业桌面应用，支持 [Claude Code CLI](https://docs.claude.com/en/docs/claude-code/overview)、[OpenAI Codex](https://openai.com/index/openai-codex/) 和 [Google Gemini CLI](https://github.com/google-gemini/gemini-cli) 三大 AI 引擎。提供完整的项目管理、会话控制、成本追踪、智能翻译和高级功能扩展。通过直观的可视化界面和创新的多引擎架构，让您更高效地使用 AI 进行辅助开发。
...
从 [Releases](https://github.com/anyme123/frog-code/releases) 下载对应平台的安装包：
...
如果安装后提示 **"Frog Code" 已损坏，无法打开** 或 **"无法验证开发者"**，请在终端执行：
...
# 方法 2：清除所有扩展属性
xattr -cr "/Applications/Frog Code.app"

# 方法 3：重新签名应用（如果上述方法不生效）
sudo codesign --force --deep --sign - "/Applications/Frog Code.app"
```

> **💡 提示**: 如果应用安装在其他位置，请将 `/Applications/Frog Code.app` 替换为实际路径。
...
```bash
sudo dpkg -i frog-code-*.deb
sudo apt-get install -f  # 修复依赖
```

**方式三：RPM 包** (Fedora/RHEL)
```bash
sudo rpm -i frog-code-*.rpm
```
...
```bash
# 1. 克隆仓库
git clone https://github.com/anyme123/frog-code.git
cd frog-code
...
```bash
# 1. Fork 并克隆仓库
git clone https://github.com/YOUR_USERNAME/frog-code.git
cd frog-code
...
日志位置：
- Windows: `%APPDATA%\frog-code\logs`
- macOS: `~/Library/Application Support/frog-code/logs`
- Linux: `~/.config/frog-code/logs`
...
- **GitHub Issues**: [报告问题](https://github.com/anyme123/frog-code/issues)
- **GitHub Discussions**: [讨论和提问](https://github.com/anyme123/frog-code/discussions)
...
[![Star History Chart](https://api.star-history.com/svg?repos=anyme123/frog-code&type=Date)](https://star-history.com/#anyme123/frog-code&Date)

---

<div align="center">

**Frog Code** - 三大 AI 引擎，一个桌面应用

Made with ❤️ by the Frog Code Team

🔗 **项目地址**: https://github.com/anyme123/frog-code
