...
// 🔥 REMOVED: ensure_api_key_helper_for_spawn() function
// This function was causing "Auth conflict" errors with ANTHROPIC_API_KEY.
// apiKeyHelper is no longer auto-injected - users manage it manually if needed.
